...
public static class BuildSettingPackageMenu
{
    private const string MenuRoot = "Tools/Package/Build Setting/";
    private const string ReadmePath = "Packages/com.actionfit.buildsetting/README.md";
